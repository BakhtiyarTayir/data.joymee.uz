    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-12 ">
                        <form class="row g-3 align-items-end" action="{{ route('admin.ads.update', $ads->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="col-3 mb-3">
                                <label for="name" class="form-label">Название</label>
                                <input type="text" name="title" class="form-control" id="name" placeholder="Название" value="{{ $ads->title }}">
                                @error('title')
                            ...
                            <div class="col-12">
                                <div class="form-group w-75">
                                    <textarea id="summernote" name="content">{{ $ads->content }}</textarea>
                                    @error('content')
                                        <div class="text-danger mt-3">Это поля необходимо заполнить {{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group w-25">
                                    <div class="img-wrap w-50">
                                        <img src="{{ url('storage/' . $ads->preview_image ) }}" alt="preview_image" class="img-fluid">
                                    </div>
                                ...
                                <div class="form-group w-25 mb-4">
                                    <div class="img-wrap w-50">
                                        <img src="{{ url('storage/' . $ads->main_image ) }}" alt="main_image" class="img-fluid">
                                    </div>
