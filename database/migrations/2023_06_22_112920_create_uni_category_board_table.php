...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('uni_category_board', function (Blueprint $table) {
            $table->unsignedBigInteger('category_board_id');
            $table->string('category_board_name', 150)->nullable();
            ...
            $table->float('category_board_price', 10, 0)->default(0);
