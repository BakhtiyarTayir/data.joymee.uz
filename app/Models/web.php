...
Route::group(['namespace'=> 'Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::group(['namespace' => 'Ads', 'prefix'=>'ads'], function() {
        ...
        Route::get('/{post}', [App\Http\Controllers\Admin\UniAd\ShowController::class, '__invoke'])->name('admin.ads.show');
        Route::get('/{post}/edit', [App\Http\Controllers\Admin\UniAd\EditController::class, '__invoke'])->name('admin.ads.edit');
        Route::patch('/{post}', [App\Http\Controllers\Admin\UniAd\UpdateController::class, '__invoke'])->name('admin.ads.update');
        Route::delete('/{post}', [App\Http\Controllers\Admin\UniAd\DeleteController::class, '__invoke'])->name('admin.ads.delete');
    });
